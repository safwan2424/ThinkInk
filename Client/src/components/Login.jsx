...
//     return (
//         <div>
//             <form className="login" onSubmit={logs}>
//                 <h1>Login</h1>
...
//     return (
//         <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 overflow-hidden">
//             <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full backdrop-blur-lg bg-opacity-30">
